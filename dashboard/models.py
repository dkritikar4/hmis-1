...
class HmisPw(models.Model):
    ...
    no_pw_severe_anaemia_treated = models.IntegerField(blank=True, null=True)
    ...
    no_spontaneous_abortion = models.IntegerField(blank=True, null=True)
    no_mtp = models.IntegerField(blank=True, null=True)
