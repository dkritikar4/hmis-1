...
class PieChldDisease(models.Model):
    year = models.CharField(max_length=20, blank=True, null=True)
    month = models.TextField(blank=True, null=True)  # This field type is a guess.
    state = models.CharField(max_length=50, blank=True, null=True)
    ...
    class Meta:
        managed = False
        db_table = 'pie_chld_disease'


class PieChldImmunzt(models.Model):
    year = models.CharField(max_length=20, blank=True, null=True)
    month = models.TextField(blank=True, null=True)  # This field type is a guess.
    state = models.CharField(max_length=50, blank=True, null=True)
    tot_chld_born = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    ...
    per_chld_immunzt_9to11m_mr = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    chld_immunzt_9to11m_measl_1st_dose = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    per_chld_immunzt_9to11m_measl_1st_dose = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
